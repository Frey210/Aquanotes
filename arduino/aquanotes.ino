...
void TDS_Sensor_Read(){
    ...
    gravityTds.setTemperature(DallTemperature);  // set the temperature and execute temperature compensation
...
void pH_Sensor_Read(){
    ...
    if(millis()-timepoint>1000U){                  //time interval: 1s
        ...
        phValue = ph.readPH(voltage,DallTemperature);  // convert voltage to pH with temperature compensation
