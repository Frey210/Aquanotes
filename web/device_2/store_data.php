...
// Simpan data sensor ke tabel 'device_2' jika ada permintaan HTTP POST atau HTTP GET
if ($_SERVER['REQUEST_METHOD'] === 'POST' || $_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $sql = "INSERT INTO device_2 (waktu, water_temperature, do, tds, air_temperature, ph, amonia)
